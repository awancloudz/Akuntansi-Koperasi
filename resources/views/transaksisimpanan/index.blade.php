...
<div id="transaksisimpanan" class="panel panel-default">
	<div class="panel-heading"><b><h4>Data Transaksi Simpanan</h4></b></div>
	<div class="panel-body">
	@include('_partial.flash_message')
	@include('transaksisimpanan.form_pencarian')
		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					{{ link_to('transaksisimpanan/' . $simpanan->id . '/edit', 'Edit', ['class' => 'btn btn-warning btn-sm']) }}
					</div>
					<div class="box-button">
					{!! Form::open(['method' => 'DELETE', 'action' => ['TransaksisimpananController@destroy',$simpanan->id]]) !!}
